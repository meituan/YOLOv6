...
class ComputeLoss:
    ...
    def __call__(
        ...
        t_feats, t_pred_scores, t_pred_distri, t_pred_angles = t_outputs[0], t_outputs[-3] ,t_outputs[-2], t_outputs[-1]
        ...
        try:
            if epoch_num < self.warmup_epoch:
                target_labels, target_bboxes, target_scores, target_angles,fg_mask = \
        ...
        # NOTE Angle Loss
        loss_angle, d_loss_angle = self.angle_loss(pred_angles, t_pred_angles, target_angles, target_scores, target_scores_sum, fg_mask, temperature)
...
class AngleLoss(nn.Module):
    ...
    def distill_loss_angle(self, logits_student, logits_teacher, temperature):
        ...
        d_loss_angle *= self.temperature**2
        return d_loss_angle
        
    def forward(self, pred_angles, t_pred_angles, target_angles, target_scores, target_scores_sum, fg_mask, temperature = 20):
