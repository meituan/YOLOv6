        ...
        with amp.autocast(enabled=self.device != "cpu"):
            ...
            if self.args.distill:
                ...
                total_loss, loss_items = self.compute_loss_distill(
                    preds, t_preds, s_featmaps, t_featmaps, targets, epoch_num, self.max_epoch, temperature, step_num
                )
    ...
    def calibrate(self, cfg):
        def save_calib_model(model, cfg):
            ...
            output_model_path = os.path.join(
                ...
                "{}_calib_{}.pt".format(
                    os.path.splitext(os.path.basename(cfg.model.pretrained))[0], cfg.ptq.calib_method
                ),
            )
